...
public abstract class Graph<VLabel, ELabel> {
    ...
    void adjacencyCleaner(Vertex input) {
     ...
     *  string DECIDE. */
    void adjacencyCleaner(Vertex input, Vertex target, String decide) {
        for (Vertex items : masterVert) {
